...
public sealed class SystemStatusQueryHandler : IRequestHandler<SystemStatusQuery, IReadOnlyList<ContainerStatusDto>>
{
    ...
    public Task<IReadOnlyList<ContainerStatusDto>> Handle(SystemStatusQuery request, CancellationToken cancellationToken) =>
